# Deploy ProSME Admin Dashboard to Vercel

This repository now contains a Vercel-ready web dashboard at `admin_web`.
...
select id, email, 'BlumeByte Admin', 'admin', 'verified'
from auth.users
where email = 'blumebyte@gmail.com'
